...
def push_commit_release(ctx, changedfiles, change_commits, push, ghrelease, prerelease):
    try:
...
def version(ctx: click.Context, show, prerelease, push, ghrelease):
    ...
    if len(changedfiles) > 0:
        push_commit_release(ctx, changedfiles, change_commits, push, ghrelease, prerelease)
